...
## 2026-06-05 — Decision: Adopt Dual Simulation-Origin Model and Open Non-Real-Money Productization Gates

**Context:** After Task 008F, Harness Engineering explicitly approved opening non-real-money productization gates for schema/contract alignment, local/test migration planning, persistence design, endpoint runtime planning, paper trading recordkeeping, system-generated learning simulations, audit events, and future non-real-money runtime sequencing.

**Decision:** HK Alpha Team adopts a dual simulation-origin model for the Simulation Investment Desk. `user_recorded` records capture paper trades entered or recorded by Harness Engineering / the user. `system_generated_learning` records capture HK Alpha Team / Simulation Investment Desk paper-trading simulations generated from approved recommendation packets to validate recommendation quality and produce reviewable learning proposals.

**Implications:** User-recorded and system-generated learning simulations must remain distinguishable and auditable in docs, schema planning, contracts, validation helpers, future migrations, future persistence writes, future endpoint runtime, trade reviews, learning proposals, and audit events. Real-money trading, autonomous real-money execution, broker execution APIs, production Supabase connection, committed secrets, silent auto-application of learning proposals, and hidden or overwritten losing simulations remain prohibited. Task 008 / Milestone M5 remains In Progress.
