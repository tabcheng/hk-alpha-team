...
| 008 | Simulation Desk MVP | In Progress | Task 008G is added after Task 008F to align docs, schema/API contract planning, and local-only tests around dual Simulation Desk origins: `user_recorded` and `system_generated_learning`. Harness Engineering approved non-real-money productization gates, but real-money trading, autonomous real-money execution, broker execution, production Supabase connection, secrets, deployment, live market data, endpoint runtime, and persistence writes remain prohibited/out of scope. |
...
- Task 008G records Harness Engineering approval for non-real-money productization gates and adopts the dual simulation-origin product model: `user_recorded` paper trades and `system_generated_learning` simulations remain distinguishable and auditable. It does not authorize real-money trading, autonomous real-money execution, broker execution, production Supabase connection, secrets, deployment, live market data, endpoint runtime, or persistence writes; Task 008 / M5 remains In Progress.
...
- Task 008 Simulation Desk MVP and M5 remain In Progress. Task 008G adds dual simulation-origin contract/schema foundation after Task 008F and records Harness Engineering approval for non-real-money productization gates; it does not implement SQL migration, endpoint runtime, persistence writes, Supabase client, production Supabase, broker integration, live market data, deployment, autonomous real-money execution, or real-money trading automation.
