...
- Only real-money trading, autonomous real-money execution, autonomous broker execution, real-money account connectivity, secrets leakage, and hidden or irreversible investment actions remain standing hard prohibitions; other non-real-money product capabilities should move through scoped PRs and Evidence Closure.
